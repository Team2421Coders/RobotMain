...
public class OI {
    ...
    public OI() {
    	 ...
    	 * 
    	 * Pneumatics:
    	 * Solenoid Push Out - Joystick 1 button 5
    	 * Solenoid Pull in - Joystick 1 button 3
    	 * Solenoid stop - Joystick 1 button 4
    	 * 
    	 * CDF(Cheval de Frise) Actuator:
    	 * Open? - Joystick 1 button 1
    	 * Close? - Joystick 1 button 2
    	 */
        ...
        //ball intake
        outBtn = new JoystickButton(stickDrive, 1);
        outBtn.whileHeld(new ballOut());
        inBtn = new JoystickButton(stickDrive, 2);
        inBtn.whileHeld(new ballIn());
        
        //pneumatics
        solReverse = new JoystickButton(stickOther, 4);
        solReverse.whenPressed(new SolenoidIn());
        solOff = new JoystickButton(stickOther, 3);
        solOff.whenPressed(new SolenoidOff());
        solForward = new JoystickButton(stickOther, 5);
        solForward.whenPressed(new SolenoidOut());
        
        //CDF
        cdfOpen = new JoystickButton(stickOther, 1);
        cdfClose = new JoystickButton(stickOther, 2);
